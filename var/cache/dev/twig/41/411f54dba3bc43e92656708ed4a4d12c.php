...
class __TwigTemplate_568b45d8a7c4dc58b962b45ff7fde41d extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_test($context, array $blocks = [])
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["projects"]) || array_key_exists("projects", $context) ? $context["projects"] : (function () { throw new RuntimeError('Variable "projects" does not exist.', 24, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            // line 25
            echo "                    <tr>
                        <td>";
            // line 26
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "firstname", [], "any", false, false, false, 26), "html", null, true);
            echo "</td>
                        <td>";
            // line 27
            ...
            echo "</td>
                        <td>";
            // line 30
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "contact", [], "any", false, false, false, 30), "html", null, true);
            echo "</td>
                        <td>
            ...
            // line 34
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_utilisateur_delete", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 34)]), "html", null, true);
            echo "\">Delete</a>
                        </td>
                    </tr>
                    ";
...
";
    ...
    {
        return array (  136 => 38,  126 => 34,  119 => 30,  115 => 29,  111 => 28,  107 => 27,  103 => 26,  100 => 25,  96 => 24,  79 => 10,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
